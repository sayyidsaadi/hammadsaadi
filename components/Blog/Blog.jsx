...
function Blog() {
  ...
  return (
    <>
      <section id="blog" className="mt-10 3xl:mt-[80px]" data-aos="fade-up">
        <SectionHeading title="Blog" subtitle="Latest Posts" />
        <div className="card-wraper grid grid-cols-1 justify-items-center md:grid-cols-2 xl:grid-cols-3 xl:justify-items-center 3xl:grid-cols-4 gap-5 mt-10 3xl:mt-14">
