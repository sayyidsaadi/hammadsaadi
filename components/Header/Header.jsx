      ...
      >
        <div className="text-center">
          ...
          <div className="flex gap-2 justify-center my-3 2xl:my-4 3xl:my-5">
            ...
            <a
              href="#contact"
              className="dark:bg-color-primary dark:hover:bg-color-primary-variant dark:hover:text-text-light py-2 px-6 bg-color-bg-primary text-text-light hover:text-text-light-variant rounded-md font-light transition-all duration-500 2xl:py-3 2xl:px-7 2xl:text-lg 3xl:p-4 3xl:px-8 3xl:text-2xl"
            >
              Lets Talk
            </a>
          </div>
