...
function Nav() {
  ...
  return (
    <>
      <nav className="flex gap-4 justify-center items-center dark:bg-color-bg-primary-variant bg-color-bg-primary backdrop-blur-lg py-2 px-3 3xl:py-4 3xl:px-5 rounded-3xl fixed left-1/2 bottom-4 translate-x-[-50%] lg:left-16 lg:flex-col lg:top-1/2 lg:translate-y-[-50%] w-fit lg:h-fit z-50">
        <a
          href="#header"
          className={`text-text-light block lg:inline-block transition-all duration-500 p-2 3xl:p-4 rounded-[50%] dark:hover:bg-color-primary-variant hover:bg-color-bg-primary-variant ${
