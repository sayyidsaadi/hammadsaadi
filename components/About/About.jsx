...
function About() {
  ...
  return (
    <>
      <section id="about" className="mt-10 3xl:mt-[80px]" data-aos="fade-up">
        <SectionHeading title="About Me" subtitle="Get To Know" />

        <div className="flex flex-col items-center justify-center md:flex-row md:gap-3 md:mt-10 3xl:mt-14">
          ...
          <div className="md:flex-[65%] lg:flex-[60%]">
            ...
            <div className="mt-3">
              <p className="dark:text-text-light-variant font-sans - serif font-300 text-sm 3xl:text-2xl text-color-bg-primary">
              ...
              <a href="#contact" className="btn-primary mt-3 inline-block">
                Lets Talk
              </a>
            </div>
          </div>
